...
<link rel="stylesheet"
	href="Template/Back-End/assets/css/jquery-ui.custom.min.css" />
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li><a href="#">Quản lý phần hướng dẫn</a></li>
...
- list item 3</textarea>
	...
	<script src="Template/Back-End/assets/js/jquery-ui.custom.min.js"></script>
	<script src="Template/Back-End/assets/js/jquery.ui.touch-punch.min.js"></script>
	<script src="Template/Back-End/assets/js/markdown.min.js"></script>
	<script src="Template/Back-End/assets/js/bootstrap-markdown.min.js"></script>
	<script src="Template/Back-End/assets/js/jquery.hotkeys.index.min.js"></script>
	<script src="Template/Back-End/assets/js/bootstrap-wysiwyg.min.js"></script>
	<script src="Template/Back-End/assets/js/bootbox.js"></script>
