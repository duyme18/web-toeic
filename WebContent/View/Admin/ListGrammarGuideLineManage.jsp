...
<head>
<meta charset="UTF-8">
<title>Thêm danh sách hướng dẫn ngữ pháp</title>
<link rel="stylesheet"
...
<body class="no-skin">
	...
	<script src="Template/Back-End/assets/js/jquery.dataTables.min.js"></script>
	<script
		src="Template/Back-End/assets/js/jquery.dataTables.bootstrap.min.js"></script>
	<script src="Template/Back-End/assets/js/dataTables.buttons.min.js"></script>
	<script src="Template/Back-End/assets/js/buttons.flash.min.js"></script>
	<script src="Template/Back-End/assets/js/buttons.html5.min.js"></script>
	<script src="Template/Back-End/assets/js/buttons.print.min.js"></script>
	<script src="Template/Back-End/assets/js/buttons.colVis.min.js"></script>
	<script src="Template/Back-End/assets/js/dataTables.select.min.js"></script>
