								...
								<div class="widget-body">
									<div class="widget-main">
										<h4 class="header blue lighter bigger">
											<i class="ace-icon fa fa-coffee green"></i>Thêm hình đại diện
											cho bài hướng dẫn ngữ pháp
										</h4>

										<div class="space-6"></div>

										<form action="UplaodGrammarGuideLineImage" method="POST"
											enctype="multipart/form-data">
											<fieldset>

												<label class="block clearfix"> Thêm ảnh: <input
													type="file" name="file"
												...
												<div class="clearfix">
													<button type="submit"
														...
														<i class="ace-icon fa fa-key"></i> <span
															class="bigger-110">Thêm hình</span>
													</button>
												</div>
